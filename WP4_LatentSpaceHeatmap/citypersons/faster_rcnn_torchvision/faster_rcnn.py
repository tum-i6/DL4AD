...
# self custom module: import will ABSOLUTE path!
from faster_rcnn_torchvision.generalized_rcnn import GeneralizedRCNN
...
class TwoMLPHead(nn.Module):
    ...
    def __init__(self, in_channels, representation_size, p = 0.5):
        super().__init__()
